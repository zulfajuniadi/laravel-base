        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {!! app('menu')->handler('users.panel-buttons.revisions')->render('inline') !!}
                    <h4>
                        {{trans('users.view_revisions', ['name' => $user->name])}}
                    </h4>
                </div>
                <div class="panel-body">
                    ...
                    @foreach($user->revisionHistory->reverse() as $history)
                        @if($history->key == 'created_at' && !$history->old_value)
                            ...
                            <dd>{{trans('users.created_this')}}</dd>
                        @else
                            ...
                            <dd>{{trans('users.changed_from_to', [
