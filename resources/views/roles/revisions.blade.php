        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {!! app('menu')->handler('roles.panel-buttons.revisions')->render('inline') !!}
                    <h4>
                        {{trans('roles.view_revisions', ['name' => $role->name])}}
                    </h4>
                </div>
                <div class="panel-body">
                    ...
                    @foreach($role->revisionHistory->reverse() as $history)
                        @if($history->key == 'created_at' && !$history->old_value)
                            ...
                            <dd>{{trans('roles.created_this')}}</dd>
                        @else
                            ...
                            <dd>{{trans('roles.changed_from_to', [
