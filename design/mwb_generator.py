...
skip_tables = ['users', 'roles', 'permission_role', 'permissions', 'assigned_roles', 'uploads', 'organization_units', 'password_reminders', 'reports', 'report_fields', 'report_columns', 'report_groupings' , 'report_eagers']
str = ''
